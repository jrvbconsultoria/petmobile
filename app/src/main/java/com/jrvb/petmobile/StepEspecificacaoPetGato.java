...
public class StepEspecificacaoPetGato extends AppCompatActivity {
    ...
    boolean voltarTelaInicial = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (b != null) {
            if (b.get("temAntes").equals("S")) {
                voltarTelaInicial = false;
            }
        }
        ...
        final RacaAdapter adapterRaca = new RacaAdapter(this, android.R.layout.simple_dropdown_item_1line, RacaResource.GetRacasGatos());
    ...
    private void addNewPet() {
        ...
        try {
            ...
            _myPets = getMyPets("_mypetsGatos", getApplicationContext());
            ...
            newPet.setTipoPetId(TipoPetEnum.GATO.getValue());
    ...
    View.OnClickListener getOnClickRemove(final Button button, final TableRow row, final UUID _id) {
        return new View.OnClickListener() {
            public void onClick(View v) {
                new AlertDialog.Builder(StepEspecificacaoPetGato.this)
